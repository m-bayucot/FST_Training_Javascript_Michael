...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(2), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
(function (global, factory) {
	 true ? module.exports = factory(__webpack_require__(0), __webpack_require__(1), __webpack_require__(6)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__layouts__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routers__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__views__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__collections__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__css_style_scss__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__css_style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__css_style_scss__);
...
window.TodoManager = {
  init: function() {
    let filterState = new __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.Model({
      filter: 'all'
    });

    this.filterChannel = __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.Radio.channel('filter');
...
class Controller extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["Object"] {
  initialize() {
    this.todoList = new __WEBPACK_IMPORTED_MODULE_6__collections__["a" /* TodoList */]();
  }
  ...
  updateHiddenElements() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#main, #footer').toggle(!!this.todoList.length);
  }

  showHeader(todoList) {
    let header = new __WEBPACK_IMPORTED_MODULE_3__layouts__["b" /* HeaderLayout */]({
      collection: todoList
    });
  ...
  showFooter(todoList) {
    let footer = new __WEBPACK_IMPORTED_MODULE_3__layouts__["a" /* FooterLayout */]({
      collection: todoList
    });
  ...
  showTodoList(todoList) {
    window.TodoManager.App.root.showChildView('main', new __WEBPACK_IMPORTED_MODULE_5__views__["a" /* ListView */]({
      collection: todoList
    }));
  }
...
class TodoManagerApp extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["Application"] {
  setRootLayout() {
    this.root = new __WEBPACK_IMPORTED_MODULE_3__layouts__["c" /* RootLayout */]();
  }
}
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(() => {
  ...
  window.TodoManager.App.on('start', function() {
    ...
    controller.router = new __WEBPACK_IMPORTED_MODULE_4__routers__["a" /* Router */]({
...
class RootLayout extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["View"]  {
  constructor() {
    let options = {
      regions: {
        header: '#header',
  ...
  initialize() {
    this.setElement(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#todoapp'), true);
  }
}
/* harmony export (immutable) */ __webpack_exports__["c"] = RootLayout;


class HeaderLayout extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["View"]  {
  constructor(options) {
    options.ui = '#new-todo';
    options.events = {
  ...
  initialize() {
    this.template = __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#template-header').html());
    this.ui = {
      input: '#new-todo'
    }
  }
...
/* harmony export (immutable) */ __webpack_exports__["b"] = HeaderLayout;


class FooterLayout extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["View"]  {
  constructor(options) {
  ...
  initialize() {
    this.template = __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#template-footer').html());
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = FooterLayout;
...
class Router extends __WEBPACK_IMPORTED_MODULE_0_backbone_marionette__["AppRouter"] {
  constructor() {
    let options = {
      appRoutes: {
        '*filter': 'filterItems'
...
class TodoView extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["View"] {
  constructor(options) {
    options.tagName = 'li';
    options.ui = {
      edit: '.edit',
  ...
  initialize() {
    this.template = __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#template-todoItemView').html());
...
/* unused harmony export TodoView */


class ListBodyView extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["CollectionView"] {
  initialize() {
    this.id = 'todo-list';
    this.tagName = 'ul';
...
/* unused harmony export ListBodyView */


class ListView extends __WEBPACK_IMPORTED_MODULE_1_backbone_marionette__["View"] {
  constructor(options) {
    options.tagName = 'li';
    options.ui = {
      toggle: '#toggle-all'
  ...
  initialize() {
    this.template = __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#template-todoListView').html());
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone_localstorage__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone_localstorage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_backbone_localstorage__);




class TodoList extends __WEBPACK_IMPORTED_MODULE_0_backbone___default.a.Collection {
  constructor(options) {
    super(options);
    this.model = __WEBPACK_IMPORTED_MODULE_1__models__["a" /* Todo */];
    this.localStorage = new __WEBPACK_IMPORTED_MODULE_2_backbone_localstorage__["LocalStorage"]('todos-backbone-backbone');
  }
...
class Todo extends __WEBPACK_IMPORTED_MODULE_0_backbone___default.a.Model {
  defaults() {
    return {
      title: '',
      completed: false,
