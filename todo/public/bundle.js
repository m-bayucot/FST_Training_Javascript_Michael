...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(0), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__todo_app__ = __webpack_require__(6);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(() => {
  new __WEBPACK_IMPORTED_MODULE_3__todo_app__["a" /* AppView */]();
  new __WEBPACK_IMPORTED_MODULE_3__todo_app__["b" /* Filters */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_backbone_localstorage__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_backbone_localstorage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_backbone_localstorage__);
...
class Todo extends __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.Model {
  defaults() {
    return {
      title: '',
      completed: false
...
class TodoList extends __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.Collection {
  constructor(options) {
    super(options);
    this.model = Todo;
    this.localStorage = new __WEBPACK_IMPORTED_MODULE_3_backbone_localstorage__["LocalStorage"]('todos-backbone');
  }
...
class TodoView extends __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.View {
  ...
  initialize() {
    this.template = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.template(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#item-template').html());
...
class AppView extends __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.View {
  ...
  initialize() {
    ...
    this.statsTemplate = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.template(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#stats-template').html());
  ...
  addOne(model) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#todo-list').append(view.render().el);
  }
  ...
  clearCompleted() {
    __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.invoke(Todos.completed(), 'destroy');
    return false;
  }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AppView;


// The Filters Router class
// ------------------------

class Filters extends __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.Router {
...
/* harmony export (immutable) */ __webpack_exports__["b"] = Filters;
